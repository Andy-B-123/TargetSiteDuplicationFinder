...
input_path_cluster = args.input_cluster_identifier_file
output_base = args.output_base
input_bam_type = args.input_type
ic(input_path_bam)
ic(output_base)
ic(input_bam_type)
ic(input_path_cluster)
...
def main():
	...
	if (input_bam_type == "SR"):
		...
		cluster_identifier_file_TSD_coordinates = process_cluster_identifier_data(input_path_cluster)
